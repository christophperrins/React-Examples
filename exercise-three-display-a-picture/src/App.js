  ...
  render() {
    return (
      <div className="App">
        ...
        {this.state.display ? <LargeDisplay display={this.state.display}/> : null}
        {this.state.images.map((img, i) => <Image key={"image" + i} source={img} eventHandler={this.eventHandler} />)}
      </div>
    );
  }
}
